...
const PurchasePage: React.FC = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === 'quantity' || name === 'pricePerUnit') {
      const quantity = name === 'quantity' ? (typeof processedValue === 'number' ? processedValue : parseFloat(processedValue as string) || 0) : formData.quantity;
      const pricePerUnit = name === 'pricePerUnit' ? (typeof processedValue === 'number' ? processedValue : parseFloat(processedValue as string) || 0) : formData.pricePerUnit;
      setFormData(prev => ({
        ...prev,
